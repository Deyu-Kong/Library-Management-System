(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["echarts3-wordcloud"] = factory(require("echarts3"));
	else
		root["echarts3-wordcloud"] = factory(root["echarts3"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var echarts3 = __webpack_require__(2);
	            ...
	            list: data.mapArray('value', function (value, idx) {
	                ...
	                return [
	                    ...
	                    itemModel.get('textStyle.normal.textSize', true)
	                        || echarts3.number.linearMap(value, valueExtent, sizeRange),
	                    idx
	                ];
	            }).sort(function (a, b) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	echarts3.extendSeriesModel({
	    ...
	    getInitialData: function (option, ecModel) {
	        ...
	        var list = new echarts3.List(dimensions, this);
	...
	echarts3.extendChartView({
	    ...
	    render: function (seriesModel, ecModel, api) {
	        ...
	        seriesModel.layoutInstance.ondraw = function (text, size, dataIdx, drawn) {
	            ...
	            var text = new echarts3.graphic.Text({
	                style: {
	            ...
	            echarts3.graphic.setHoverStyle(
	                text, echarts3.util.extend(
